<!--Start - Google Map -->
<div
    class="mt-4 border-2 border-gray-300 rounded-lg shadow-xl lg:p-1 md:mt-2 sm:mt-2 dark:shadow-gray-800 sm:p-6 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
    <div class="container mx-auto">

        <div class="relative h-0 pb-48 overflow-hidden rounded-lg">
