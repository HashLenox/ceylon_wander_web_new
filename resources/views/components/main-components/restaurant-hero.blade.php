<div class="relative pb-2 rounded-lg pt-36 sm:pt-60">
    <div
        class=" rounded-lg w-full  absolute top-0 left-0 z-0 h-48 sm:h-[350px] bg-no-repeat bg-cover bg-center bg-blend-multiply">

        <x-main-components.restaurant-img-slider :images="$restaurant->images" />
    </div>


    <div class="absolute flex items-center justify-between space-x-2 top-6 right-6">
        <button class="flex items-center p-2 bg-white rounded-full bg-opacity-70">
        ...
        <button class="flex items-center p-2 bg-white rounded-full bg-opacity-90">
    ...
    <div class=" w-[200px] mx-auto lg:mt-4 px-6 md:px-8">
        <div class="relative z-10 flex flex-col items-center justify-center lg:flex-row">
            <img src="{{ asset('assets/images/logo.png') }}" alt="logo"
                class="border-4 border-white border-solid rounded-full max-sm:w-20">

        </div>
    </div>

    <div class="flex flex-col justify-between lg:items-center max-lg:gap-4 lg:flex-row">
        <div class="block">
            <h3 class="mb-1 text-4xl font-bold text-gray-900 font-manrope">{{ $restaurant->name }}</h3>
            <ul class="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-7">
                <li>
                    <a href="#"
                        ...
                        <svg class="transition-all duration-500 stroke-gray-500 group-hover:stroke-gray-900"
                ...
                <li><a href="#"
                        class="flex items-center gap-2 py-1 sm:py-3.5 font-medium text-base leading-7 text-gray-500 group transition-all duration-500 hover:text-gray-900">
                        <svg class="transition-all duration-500 fill-gray-500 group-hover:fill-gray-900"
        ...
        <div class="grid grid-cols-1 min-[440px]:grid-cols-2 gap-7">
            <div class="p-5 bg-indigo-200 rounded-2xl ">
                <p class="mb-1 text-xl font-semibold leading-8 text-indigo-600">351</p>
                <p class="text-sm font-normal leading-6 text-indigo-900">Completed Sessions</p>
            </div>
            <div class="p-5 rounded-2xl bg-sky-200">
                <p class="mb-1 text-xl font-semibold leading-8 text-sky-600">2+</p>
                <p class="text-sm font-normal leading-6 text-cyan-900">Years Experiences</p>
            </div>
        </div>
    </div>
