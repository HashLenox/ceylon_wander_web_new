                ...
                <form class="mb-6" wire:submit="submit">
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center py-2 px-3 border-t dark:border-gray-600">
                            ...
                            <div class="text-sm font-semibold text-green-600 dark:text-green-400" wire:loading
                                wire:target="images">
                            ...
                            <div class="flex pl-0 space-x-1 sm:pl-2">
                                ...
                                <button type="button" id="upload-button"
                                    class="{{ $imageCount >= 4 ? 'hidden' : '' }} inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                                    <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor" viewBox="0 0 16 20">
                                        <path
                                            d="M14.066 0H7v5a2 2 0 0 1-2 2H0v11a1.97 1.97 0 0 0 1.934 2h12.132A1.97 1.97 0 0 0 16 18V2a1.97 1.97 0 0 0-1.934-2ZM10.5 6a1.5 1.5 0 1 1 0 2.999A1.5 1.5 0 0 1 10.5 6Zm2.221 10.515a1 1 0 0 1-.858.485h-8a1 1 0 0 1-.9-1.43L5.6 10.039a.978.978 0 0 1 .936-.57 1 1 0 0 1 .9.632l1.181 2.981.541-1a.945.945 0 0 1 .883-.522 1 1 0 0 1 .879.529l1.832 3.438a1 1 0 0 1-.031.988Z" />
