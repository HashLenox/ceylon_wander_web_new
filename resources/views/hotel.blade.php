<x-layout>
    <div class=" bg-white dark:bg-gray-900">
        <div class=" container bg-white  border border-gray-200  shadow-md dark:bg-gray-800 dark:border-gray-700">
            <div
                ...
                <div class="relative py-8 px-4 mx-auto max-w-screen-xl text-white lg:py-16 xl:px-0 z-1 ">
                    ...
                    <form action="#"
                        class="grid gap-y-8 p-4 w-full bg-white rounded lg:gap-x-4 lg:grid-cols-9 lg:mt-12 dark:bg-gray-800">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-6 border-b-2">
            <div class="grid gap-3 bg-white dark:bg-gray-900 p-4 md:p-2 sm:p-2">
                <div class="flex items-center justify-between mt-3">
                    <h6 class=" text-3xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                        Recommended for you</h6>
                    <button
                        class="rounded-lg px-4 py-2 font-semibold text-purple-950 hover:text-purple-500 underline duration-300">See
                        all</button>
                </div>
    ...
    <section class="bg-white dark:bg-gray-900 p-8">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-6 sm:py-2 rounded-xl border-2">
            ...
            <aside aria-label="Top destionations"
                class="py-8 bg-white dark:bg-gray-900 md:py-2 sm:py-2   antialiased">
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
                                    <div
                                        ...
                                        <a href="#"
                                            ...
                                            Read more <svg class="mt-px ml-1 w-3 h-3" aria-hidden="true"
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                ...
                <p class="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">Try Flowbite Platform
                    for 30 days. No credit card required.</p>
                <a href="#"
                    class="text-white bg-purple-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Free
                    trial for 30 days</a>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="grid space-y-8 lg:grid-cols-2 lg:gap-12 lg:space-y-0">
                <div>
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Compare
                    ...
                    <a href="#"
                        ...
                        Learn what makes Flowbite different <svg class="ml-1 w-5 h-5" fill="currentColor"
                            viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
