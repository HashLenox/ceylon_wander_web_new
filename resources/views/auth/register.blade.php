<x-guest-layout>
    <x-authentication-card>
        ...
        <x-validation-errors class="mb-4 bg-white" />

        <form method="POST" action="{{ route('register') }}">
            @csrf

            <div class="mt-4">
                <x-input label="Name" id="name" class="block mt-1 w-full" type="text" name="name"
                    :value="old('name')" required autofocus autocomplete="name" />
            </div>

            <div class="mt-4">
                <x-input label="Username" id="username" class="block mt-1 w-full" type="text" name="username"
